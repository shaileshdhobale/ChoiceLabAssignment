...
var citiesListArray = [
    ...
    {"city":"Amreli", "state":"Gujrat"},
    {"city":"Anand", "state":"Gujrat"},
    {"city":"Ankleshwar", "state":"Gujrat"},
    {"city":"Bharuch", "state":"Gujrat"},
    {"city":"Bhavnagar", "state":"Gujrat"},
    {"city":"Bhuj", "state":"Gujrat"},
    {"city":"Cambay", "state":"Gujrat"},
    {"city":"Dahod", "state":"Gujrat"},
    {"city":"Deesa", "state":"Gujrat"},
    {"city":"Dharampur", "state":"Gujrat"},
    {"city":"Dholka", "state":"Gujrat"},
    {"city":"Gandhinagar", "state":"Gujrat"},
    {"city":"Godhra", "state":"Gujrat"},
    {"city":"Himatnagar", "state":"Gujrat"},
    {"city":"Idar", "state":"Gujrat"},
    {"city":"Jamnagar", "state":"Gujrat"},
    {"city":"Junagadh", "state":"Gujrat"},
    {"city":"Kadi", "state":"Gujrat"},
    {"city":"Kalavad", "state":"Gujrat"},
    {"city":"Kalol", "state":"Gujrat"},
    {"city":"Kapadvanj", "state":"Gujrat"},
    {"city":"Karjan", "state":"Gujrat"},
    {"city":"Keshod", "state":"Gujrat"},
    {"city":"Khambhalia", "state":"Gujrat"},
    {"city":"Khambhat", "state":"Gujrat"},
    {"city":"Kheda", "state":"Gujrat"},
    {"city":"Khedbrahma", "state":"Gujrat"},
    {"city":"Kheralu", "state":"Gujrat"},
    {"city":"Kodinar", "state":"Gujrat"},
    {"city":"Lathi", "state":"Gujrat"},
    {"city":"Limbdi", "state":"Gujrat"},
    {"city":"Lunawada", "state":"Gujrat"},
    {"city":"Mahesana", "state":"Gujrat"},
    {"city":"Mahuva", "state":"Gujrat"},
    {"city":"Manavadar", "state":"Gujrat"},
    {"city":"Mandvi", "state":"Gujrat"},
    {"city":"Mangrol", "state":"Gujrat"},
    {"city":"Mansa", "state":"Gujrat"},
    {"city":"Mehmedabad", "state":"Gujrat"},
    {"city":"Modasa", "state":"Gujrat"},
    {"city":"Morvi", "state":"Gujrat"},
    {"city":"Nadiad", "state":"Gujrat"},
    {"city":"Navsari", "state":"Gujrat"},
    {"city":"Padra", "state":"Gujrat"},
    {"city":"Palanpur", "state":"Gujrat"},
    {"city":"Palitana", "state":"Gujrat"},
    {"city":"Pardi", "state":"Gujrat"},
    {"city":"Patan", "state":"Gujrat"},
    {"city":"Petlad", "state":"Gujrat"},
    {"city":"Porbandar", "state":"Gujrat"},
    {"city":"Radhanpur", "state":"Gujrat"},
    {"city":"Rajkot", "state":"Gujrat"},
    {"city":"Rajpipla", "state":"Gujrat"},
    {"city":"Rajula", "state":"Gujrat"},
    {"city":"Ranavav", "state":"Gujrat"},
    {"city":"Rapar", "state":"Gujrat"},
    {"city":"Salaya", "state":"Gujrat"},
    {"city":"Sanand", "state":"Gujrat"},
    {"city":"Savarkundla", "state":"Gujrat"},
    {"city":"Sidhpur", "state":"Gujrat"},
    {"city":"Sihor", "state":"Gujrat"},
    {"city":"Songadh", "state":"Gujrat"},
    {"city":"Surat", "state":"Gujrat"},
    {"city":"Talaja", "state":"Gujrat"},
    {"city":"Thangadh", "state":"Gujrat"},
    {"city":"Tharad", "state":"Gujrat"},
    {"city":"Umbergaon", "state":"Gujrat"},
    {"city":"Umreth", "state":"Gujrat"},
    {"city":"Una", "state":"Gujrat"},
    {"city":"Unjha", "state":"Gujrat"},
    {"city":"Upleta", "state":"Gujrat"},
    {"city":"Vadnagar", "state":"Gujrat"},
    {"city":"Vadodara", "state":"Gujrat"},
    {"city":"Valsad", "state":"Gujrat"},
    {"city":"Vapi", "state":"Gujrat"},
    {"city":"Vapi", "state":"Gujrat"},
    {"city":"Veraval", "state":"Gujrat"},
    {"city":"Vijapur", "state":"Gujrat"},
    {"city":"Viramgam", "state":"Gujrat"},
    {"city":"Visnagar", "state":"Gujrat"},
    {"city":"Vyara", "state":"Gujrat"},
    {"city":"Wadhwan", "state":"Gujrat"},
    {"city":"Wankaner", "state":"Gujrat"},
...
cities.statics.buildObject = function () {
    return citiesListArray;
};


cities.statics.addCitiesList = function (citiesObj, callback) {
    var METHOD_NAME = "[addCitiesList] ";
    async.eachSeries(citiesListArray, function (single, cb) {
        CitiesList.findOne({city: single.city, state: single.state}, function (error, result) {
            if (error) {
                logger.error(METHOD_NAME + JSON.stringify(error));
                cb(error);
            } else if (_.isEmpty(result)) {
                CitiesList.create({city: single.city, state: single.state}, function (error, result) {
                    if (error) {
                        logger.error(METHOD_NAME + JSON.stringify(error));
                        cb(error);
                    } else {
        ...
        if (error) {
            ...
            // logger.info("All CitiesList added successfully.");
            callback();
        }
    });
};
...
var CitiesList = mongoose.model('cities', cities, 'cities');
